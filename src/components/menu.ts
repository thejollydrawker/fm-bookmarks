    ...
    render() {
        ...
        return html`
            <nav>
                ...
                <div class="overlay" .hidden=${!this.isOpen}></div>
                <div class="mobile-menu" .hidden=${!this.isOpen}>
                ...
                <div class="flex-container-icons" style="${this.isOpen ? 'display: flex;' : 'display: none;'}">
